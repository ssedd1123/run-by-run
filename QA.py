...
if __name__ == '__main__':
    ...
    parser.add_argument('-rr', '--rejectionRange', type=float, default=5, help='The factor of SD range beyon which a run is rejected')
    parser.add_argument('-pr', '--plotRange', type=float, default=10, help='The factor of SD of all good runs in the QA plot')
    parser.add_argument('-ms', '--minSize', type=int, default=5, help='Minimum number of runs in a segment')
